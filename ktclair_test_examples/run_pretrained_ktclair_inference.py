...
import requests
import torch
from ktclair_test.data.cmr_data import CMRDataset
from ktclair_test.data.transforms import CMRDataTransform
from ktclair_test.models.ktclair import KTCLAIR
from tqdm import tqdm

from typing import Dict, Tuple, Union
from ktclair_test.utils import str_to_class
...
def load_model(task):
    if task.lower() == 'cine':
        model = KTCLAIR(
            forward_operator = str_to_class("ktclair_test", "fft2"),
            backward_operator = str_to_class("ktclair_test", "ifft2"),
            ### sens_model
